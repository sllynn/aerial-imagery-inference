...
# MAGIC %sh
# MAGIC # Install from `requirements.lock` (full transitive pins generated by
# MAGIC # `uv pip compile --python-version 3.12 --python-platform
# MAGIC #  x86_64-unknown-linux-gnu requirements.txt -o requirements.lock`).
# MAGIC # Refresh the lock with the same command after editing requirements.txt.
# MAGIC uv pip install \
# MAGIC   --no-binary rasterio \
# MAGIC   --excludes ../excludes.txt \
# MAGIC   -r ../requirements.lock
